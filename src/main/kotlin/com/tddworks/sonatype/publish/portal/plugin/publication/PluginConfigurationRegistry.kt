 ...
 * 
 * This class serves as a factory for creating a configured PluginBasedConfigurator
 * with all the standard strategies pre-registered.
 */
object PluginConfigurationRegistry {
     ...
     * 
     * Use this when you want to register only specific strategies or
     * add custom strategies not included in the standard set.
     * 
