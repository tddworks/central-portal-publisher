...
data class WizardStartResult(val currentStep: WizardStep, val detectedInfo: DetectedProjectInfo)
...
data class DetectedDeveloper(val name: String, val email: String = "")
