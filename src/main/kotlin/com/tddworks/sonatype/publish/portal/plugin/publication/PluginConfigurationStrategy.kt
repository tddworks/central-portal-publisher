 ...
 * 
 * Each implementation handles configuration for a specific project type (Kotlin JVM, Java Library, etc.)
 */
interface PluginConfigurationStrategy {
    ...
    /**
     * Returns the priority of this strategy when multiple strategies can handle a project.
     * Higher numbers = higher priority.
     * 
     * Default priority is 0. Override for strategies that should take precedence.
     * Example: Kotlin Multiplatform should have higher priority than Kotlin JVM.
     * 
