...
/**
 * Validates authentication credentials for Sonatype Portal publishing. Follows Chicago School TDD
...
data class AuthenticationViolation(val field: String, val message: String, val code: String)
