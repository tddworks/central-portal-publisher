 ...
 * Provides structured validation results with severity levels and actionable suggestions.
 */
            ...
            listOf(
                ...
                if (severityViolations.isNotEmpty()) {
                    ...
                    severityViolations.forEach { violation ->
                        ...
                        violation.fixCommand?.let { 
                            builder.appendLine("    🔧 ${it}")
                        }
                        violation.documentationUrl?.let { 
                            builder.appendLine("    📖 ${it}")
                        }
                    }
                    builder.appendLine()
