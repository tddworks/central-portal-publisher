...
class GitInfoDetectorTest {
    ...
    fun `should detect github ssh remote url`() {
        ...
        assertThat(result!!.config.projectInfo.url)
            .isEqualTo("https://github.com/tddworks/central-portal-publisher")
        assertThat(result.config.projectInfo.scm.url)
            .isEqualTo("https://github.com/tddworks/central-portal-publisher")
        assertThat(result.config.projectInfo.scm.connection)
            .isEqualTo("scm:git:https://github.com/tddworks/central-portal-publisher.git")
        assertThat(result.config.projectInfo.scm.developerConnection)
            .isEqualTo("scm:git:git@github.com:tddworks/central-portal-publisher.git")
    ...
    fun `should detect gitlab ssh remote url`() {
        ...
        assertThat(result).isNotNull
        assertThat(result!!.config.projectInfo.url)
            .isEqualTo("https://gitlab.com/mygroup/myproject")
        assertThat(result.config.projectInfo.scm.url)
            .isEqualTo("https://gitlab.com/mygroup/myproject")
        assertThat(result.config.projectInfo.scm.connection)
            .isEqualTo("scm:git:https://gitlab.com/mygroup/myproject.git")
        assertThat(result.config.projectInfo.scm.developerConnection)
            .isEqualTo("scm:git:git@gitlab.com:mygroup/myproject.git")
    }
    ...
    fun `should handle generic ssh format`() {
        ...
        assertThat(result.config.projectInfo.scm.connection)
            .isEqualTo("scm:git:https://example.com/user/repo.git")
        assertThat(result.config.projectInfo.scm.developerConnection)
            .isEqualTo("scm:git:git@example.com:user/repo.git")
    }
    ...
    fun `should detect developer info from git config`() {
        ...
        assertThat(result!!.detectedValues["projectInfo.developer.name"]?.value)
            .isEqualTo("John Developer")
        assertThat(result.detectedValues["projectInfo.developer.email"]?.value)
            .isEqualTo("john@example.com")
        assertThat(result.detectedValues["projectInfo.developer.name"]?.confidence)
    ...
    fun `should add warning when no remote url found`() {
        ...
        assertThat(result!!.warnings)
            .contains("No suitable Git remote URL found for SCM configuration")

        // But should still detect developer info
        assertThat(result.detectedValues)
            .containsKeys("projectInfo.developer.name", "projectInfo.developer.email")
    }
