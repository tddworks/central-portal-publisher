...
class Task26VerificationTest {
    ...
    fun `TASK-2_6 VERIFICATION - Default values should be provided for all configuration sections`() {
        ...
        assertThat(result.projectInfo.license.name)
            .isEqualTo("Apache License 2.0") // Default license
    ...
    fun `TASK-2_6 VERIFICATION - Conditional defaults based on project context`() {
        ...
        val apiProject =
            ProjectBuilder.builder().withName("my-awesome-api").withProjectDir(tempDir).build()

        val clientProject =
            ProjectBuilder.builder().withName("http-client").withProjectDir(tempDir).build()
        ...
        assertThat(apiResult.projectInfo.description)
            .isEqualTo("A library for publishing to Maven Central")
        assertThat(clientResult.projectInfo.description)
            .isEqualTo("A library for publishing to Maven Central")
    ...
    fun `TASK-2_6 VERIFICATION - Override mechanism should work correctly`() {
        ...
        assertThat(result.projectInfo.license.name)
            .isEqualTo("Apache License 2.0") // Default applied
    ...
    fun `TASK-2_6 VERIFICATION - Summary of Smart Defaults Implementation`() {
        ...
        features.forEach { feature -> println(feature) }
