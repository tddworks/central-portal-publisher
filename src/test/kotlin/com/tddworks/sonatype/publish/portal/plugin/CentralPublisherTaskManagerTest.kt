...
class CentralPublisherTaskManagerTest {
    ...
    fun `should set correct task descriptions`() {
        ...
        assertThat(validateTask.description)
            .isEqualTo("✅ Check if your project is ready to publish (no upload, safe to run)")
        assertThat(bundleTask.description)
            .isEqualTo("📦 Prepare your artifacts for publishing (signs, validates, bundles)")
        assertThat(setupTask.description)
            .isEqualTo("🧙 Set up your project for Maven Central publishing (interactive guide)")
    }
    ...
    fun `should set up correct task dependencies`() {
        ...
        assertThat(publishTask.taskDependencies.getDependencies(publishTask)).contains(bundleTask)
    }
