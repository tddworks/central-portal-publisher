...
class WelcomeStepProcessorTest {
    ...
    fun `should display welcome message with progress indicator`() {
        ...
        assertThat(displayedMessage).contains("This wizard will help you configure publishing to Maven Central")
    }
    ...
    fun `should show configuration overview in welcome message`() {
        ...
        assertThat(displayedMessage).contains("• Project information (name, URL, description, developers)")
    ...
    private fun createTestContextWithDetectedInfo() = WizardContext(
    ...
    private fun createTestContextWithoutDetectedInfo() = WizardContext(
        project = TestProjectBuilder.createProject("test-project"),
        detectedInfo = null,
        wizardConfig = TestConfigBuilder.createConfig(),
        enableGlobalGradlePropsDetection = false
    ...
    private fun createTestContextWithPartialDetectedInfo() = WizardContext(
        project = TestProjectBuilder.createProject("test-project"),
        detectedInfo = DetectedProjectInfo(
            projectName = "test-project",
