...
class SmartDefaultProviderTest {
    ...
    fun `should not override existing values`() {
        // Given
        val provider = object : SmartDefaultProvider {
        ...
        val baseConfig = createEmptyConfig().copy(
            projectInfo = createEmptyConfig().projectInfo.copy(
    ...
    fun `should skip providers that cannot provide defaults`() {
        // Given
        val inactiveProvider = object : SmartDefaultProvider {
        ...
        val activeProvider = object : SmartDefaultProvider {
