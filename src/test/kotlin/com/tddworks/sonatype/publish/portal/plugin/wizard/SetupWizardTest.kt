...
class SetupWizardTest {
    ...
    fun setup() {
        ...
        setupWizard =
            SetupWizard(project, mockPromptSystem, enableGlobalGradlePropsDetection = false)
    }
    ...
    fun `should guide through all wizard steps with clear separation of concerns`() {
        ...
        assertThat(result.stepsCompleted)
            .containsExactly(
                WizardStep.WELCOME,
    ...
    fun `should use smart defaults when no input provided`() {
        ...
        assertThat(result.finalConfiguration.projectInfo.license.name)
            .isEqualTo("Apache License 2.0")
        assertThat(result.finalConfiguration.publishing.autoPublish)
            .isFalse() // Conservative default
    ...
    fun `should generate gradle properties with only missing sections when partially auto-detected`() {
        ...
        val wizardWithPartialDetection =
            SetupWizard(project, mockPromptSystem, enableGlobalGradlePropsDetection = false)
    ...
    fun `should use auto-detected values in generated build file`() {
        ...
        val mockDetectedInfo =
            DetectedProjectInfo(
                projectName = "auto-detected-project",
                projectUrl = "https://github.com/auto/detected",
                developers =
                    listOf(DetectedDeveloper(name = "Auto Developer", email = "auto@developer.com")),
            )
    ...
    fun `should generate dynamic file list based on what was actually created`() {
        ...
        assertThat(result.filesGenerated)
            .containsExactly("build.gradle.kts", ".gitignore", ".github/workflows/publish.yml")
