...
class GenericProjectDefaultProviderTest {
    ...
    fun `should provide generic license default`() {
        ...
        assertThat(defaults.projectInfo.license.url).isEqualTo("https://www.apache.org/licenses/LICENSE-2.0.txt")
    ...
    fun `should provide generic project description`() {
        ...
        // Then
        assertThat(defaults.projectInfo.description).isEqualTo("A library for publishing to Maven Central")
    }
