...
class SimplifiedTasksTest {
    ...
    fun `should register publishToCentral task`() {
        ...
        assertThat(project.tasks.findByName("publishToCentral")?.group).isEqualTo("Central Publishing")
    ...
    fun `should register bundleArtifacts task`() {
        ...
        assertThat(project.tasks.findByName("bundleArtifacts")?.group).isEqualTo("Central Publishing")
    ...
    fun `should register validatePublishing task`() {
        ...
        assertThat(project.tasks.findByName("validatePublishing")?.group).isEqualTo("Central Publishing")
