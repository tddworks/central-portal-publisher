...
class CentralPublisherDSLTest {
    ...
    fun `should support nested DSL blocks`() {
        ...
        assertThat(config.projectInfo.scm.connection)
            .isEqualTo("scm:git:https://github.com/full/project.git")
...
private fun Project.centralPublisher(
    configure: CentralPublisherExtension.() -> Unit
): CentralPublisherConfig {
    val extension =
        extensions.findByType(CentralPublisherExtension::class.java)
