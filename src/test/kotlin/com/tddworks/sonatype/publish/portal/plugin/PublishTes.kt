...
//        val sonatypeDestinationPath = mock<Provider<Directory>>(defaultAnswer =
// RETURNS_DEEP_STUBS)
...
//        // When
//        val result =
// sonatypePortalPublishingTaskManager.registerPublishPublicationToMavenRepositoryTask(
//            project,
//            "some-name",
...
//            sonatypePortalPublishingTaskManager.preparePublishingBuildRepository("some-name",
// project).get().asFile.path
//
