...
/**
 * A simple utility class demonstrating a single-module library.
 * This would be published to Maven Central using the Central Portal Publisher plugin.
 */
object StringUtils {
    ...
    fun countWordOccurrences(text: String, word: String): Int {
        ...
        return normalizedText.split("\\W+".toRegex())
            .count { it == normalizedWord }
    }
}